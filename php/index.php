...
<a href="../php/estadosphp" class="text-white hover:text-yellow-200 font-medium transition duration-300 px-3 py-2 rounded-md">
  <i class="fas fa-truck mr-2"></i>Estado de pedidos
</a>
...
<!-- asta ca termina el escrip para movil -->
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8 border-l-4 border-yellow-500">
            ...
            <p class="text-gray-600">Gestiona tus productos de joyería de manera eficiente.</p>
        </div>
            ...
            <div class="p-6">
                <form action="" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Campo de fotos (ahora con múltiple selección) -->
